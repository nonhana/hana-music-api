...
const sdkReleaseReady =
  !sdkPackage.private && typeof sdkPackage.exports === 'object' && sdkPackage.exports !== null
const sdkTest = sdkReleaseReady ? test : test.skip
...
describe('sdk release contract', () => {
  sdkTest('should expose single-package ESM metadata with explicit export boundaries', () => {
  ...
  sdkTest(
    'should keep the root runtime surface inside the frozen allowlist/denylist contract',
    async () => {
  ...
  sdkTest(
    'should provide release governance files with changesets and trusted publishing guardrails',
    () => {
  ...
  sdkTest(
    'should pack a consumer-safe tarball and allow only approved runtime imports',
    () => {
