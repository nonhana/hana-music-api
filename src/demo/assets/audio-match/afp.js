...
const AFP_ASSET_BASE_URL = new URL('./', document.currentScript?.src ?? window.location.href).href

function createAudioFingerprintRuntimeModule() {
  const moduleOptions = {
    locateFile(fileName) {
      return AFP_ASSET_BASE_URL + fileName
    },
  }
  const module = {
  ...
  const require = function unsupportedRequire(request) {
    throw new Error('AFP runtime attempted to require ' + request + ' in the browser')
  }
  ...
  ;((t, e, r) => {
    ...
    y
      ? ((m = h ? r(997).dirname(m) + '/' : '//'),
        ...
        function (t, e) {
          ...
          var r
          ;((r = e) instanceof Re || g('exiting due to exception: ' + r), process.exit(t))
        },
        (o.inspect = function () {
    ...
    function it(t) {
      var e = ot[t]
      return (e || (t >= ot.length && (ot.length = t + 1), (ot[t] = e = L.get(t))), e)
    }
    function at(t) {
      ;((this.excPtr = t),
        (this.ptr = t - 16),
    ...
    function xt(t, e, r) {
      o.hasOwnProperty(t)
        ? ((void 0 === r || (void 0 !== o[t].overloadTable && void 0 !== o[t].overloadTable[r])) &&
    ...
    function Yt(t, e) {
      if (null === e) return (this.isReference && vt('null is not a valid ' + this.name), 0)
    ...
    function Vt(t, e) {
      ...
      if (((r = Ht(e.$$.ptr, n, this.registeredClass)), this.isSmartPointer))
        switch (
          (void 0 === e.$$.smartPtr && vt('Passing raw pointer to smart pointer is illegal'),
          this.sharingPolicy)
        ) {
          case 0:
            e.$$.smartPtrType === this
    ...
    function ee(t) {
      ...
      function o() {
        return this.isSmartPointer
          ...
          : te(this.registeredClass.instancePrototype, { ptrType: this, ptr: t })
      }
      var i,
    ...
    function ie(t, e) {
      var r,
        ...
        i = (t = ct(t)).includes('j')
          ...
          : it(e)
      return (
        'function' != typeof i && vt('unknown function pointer with signature ' + t + ': ' + e), i
      )
    }
    var ae = void 0
    function ue(t) {
    ...
    var pe = [],
      de = [{}, { value: void 0 }, { value: null }, { value: !0 }, { value: !1 }]
    function he(t) {
    ...
    var Te = {
      ...
      printChar: function (t, e) {
        var r = Te.buffers[t]
        0 === e || 10 === e ? ((1 === t ? v : g)(P(r, 0)), (r.length = 0)) : r.push(e)
      },
      varargs: void 0,
      get: function () {
      ...
      var m = {
        ...
        '%V': function (t) {
          var e,
            ...
            o = h(r),
            i = h(n),
            a = Fe(new Date(t.tm_year + 1900, 0, 1), t.tm_yday)
          return d(a, o) < 0
            ? '53'
            : d(i, a) <= 0
              ? '01'
    ...
    var Se,
      Oe = {
        d: function (t, e, r, n) {
          K(
            'Assertion failed: ' +
              A(t) +
              ', at: ' +
              [e ? A(e) : 'unknown filename', r, n ? A(n) : 'unknown function'],
          )
        },
        g: function (t) {
          return ke(t + 16) + 16
        ...
        A: function (t, e, r, n, o, i, a, u, s, c, f, l, p) {
          ;((f = ct(f)), (i = ie(o, i)), u && (u = ie(a, u)), c && (c = ie(s, c)), (p = ie(l, p)))
          var d = dt(f)
          ;(xt(d, function () {
            ...
            bt([t, e, r], n ? [n] : [], function (e) {
              ...
              var a = ht(d, function () {
                  if (Object.getPrototypeOf(this) !== s) throw new mt("Use 'new' to construct " + f)
              ...
              return ((Mt[t] = { pointerType: y, constPointerType: m }), ne(d, a), [h, y, m])
            }))
        },
        ...
        c: function (t, e, r, n, o, i, a, u) {
          ...
          ;((e = ct(e)),
            ...
            bt([], [t], function (t) {
              ...
              return (
                void 0 === f ||
                (void 0 === f.overloadTable && f.className !== t.name && f.argCount === r - 2)
        ...
        a: function (t, e, r) {
          ...
          _t(
            t,
            { name: (r = ct(r)), fromWireType: o, argPackAdvance: 8, readValueFromPointer: o },
            ...
            toWireType: function (t, e) {
              ...
              if (((R[i >> 2] = o), r && n)) D(e, O, i + 4, o + 1)
                ...
                for (var a = 0; a < o; ++a) {
                  ...
                  ;(u > 255 &&
                    (We(i), vt('String has UTF-16 code units that do not fit in 8 bits')),
                    (O[i + 4 + a] = u))
                }
          ...
          ;((r = ct(r)),
            ...
            _t(t, {
              ...
              toWireType: function (t, n) {
                ...
                var i = a(n),
                  s = ke(4 + i + e)
                return ((R[s >> 2] = i >> u), o(n, s + 4, i + e), null !== t && t.push(We, s), s)
              },
              argPackAdvance: 8,
              readValueFromPointer: Bt,
              destructorFunction: function (t) {
        ...
        u: function (t, e) {
          ...
          return (
            Ce().forEach(function (n, o) {
              ...
              ;((j[(t + 4 * o) >> 2] = i),
                (function (t, e, r) {
                  for (var n = 0; n < t.length; ++n) S[e++ >> 0] = t.charCodeAt(n)
                  r || (S[e >> 0] = 0)
                })(n, i),
                (r += n.length + 1))
            }),
...
function waitForExtractor(runtime) {
  if (typeof runtime.ExtractQueryFP === 'function') {
  ...
  return new Promise((resolve, reject) => {
    const timeoutId = window.setTimeout(() => {
      ...
      reject(new Error('AFP runtime initialization timed out'))
    }, 10000)
...
async function GenerateFP(floatArray) {
  const runtime = await waitForExtractor(createAudioFingerprintRuntimeModule())
  const pcmBuffer = Float32Array.from(floatArray)
  const fingerprintVector = runtime.ExtractQueryFP(pcmBuffer.buffer)
  const fingerprintBytes = new Uint8Array(fingerprintVector.size())

  for (let index = 0; index < fingerprintVector.size(); index += 1) {
    fingerprintBytes[index] = fingerprintVector.get(index)
  }

  return encodeBase64(fingerprintBytes)
}
