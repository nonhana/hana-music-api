...
let AudioFingerprintRuntime = () => {
  ...
  function UTF16ArrayToString(t, e) {
    ...
    if ((r = n << 1) - t > 32 && UTF16Decoder) return UTF16Decoder.decode(O.subarray(t, r))
  ...
  var Te = {
    ...
    printChar: function (t, e) {
      var r = Te.buffers[t]
      0 === e || 10 === e ? ((1 === t ? v : g)(UTF8ArrayToString(r, 0)), (r.length = 0)) : r.push(e)
    },
    varargs: void 0,
    get: function () {
      ...
      d: function (t, e, r, n) {
        abort(
          'Assertion failed: ' +
            UTF8ToString(t) +
            ', at: ' +
            [e ? UTF8ToString(e) : 'unknown filename', r, n ? UTF8ToString(n) : 'unknown function'],
        )
      },
      g: function (t) {
        return ke(t + 16) + 16
          ...
          toWireType: function (t, e) {
            ...
            if (((R[i >> 2] = o), r && n)) stringToUTF8Array(e, O, i + 4, o + 1)
              ...
              for (var a = 0; a < o; ++a) {
                ...
                ;(u > 255 && (We(i), vt('String has UTF-16 code units that do not fit in 8 bits')),
                  (O[i + 4 + a] = u))
              }
...
if (typeof exports != 'undefined') /* Node, PythonMonkey */ exports.GenerateFP = GenerateFP
